...
/**
 * Finds the common-services ancestor path between two states.
 *
...
/**
 * Merges a set of parameters with all parameters inherited between the common-services parents of the
...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
  ...
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $urlRouter,   $location,   $urlMatcherFactory) {
     ...
     * specified in a parent state. Parameter inheritance only works between common-services ancestor states, I.e.
