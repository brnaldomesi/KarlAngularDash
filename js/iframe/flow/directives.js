 ...
 */
angular.module('Flow.Directives', []);
        ...
        link:function (scope, element, attrs) {
            $timeout(function () {
                if(typeof fbq === 'undefined'){
                    ...
                    console.log($rootScope.fasebookPixelId);
...
angular.module('Flow.Directives')
    .directive('googleAnalytics', function ($rootScope, $timeout) {
        return {
            ...
            link: function (scope, element, attrs) {
                $timeout(function () {
                    mixpanel.track('Iframe Flow Entry page', {'pageName': attrs.analyticsPage});
                    if ($rootScope.loginUser != null) {
                        scope.userId = $rootScope.login_id;
